...
And don't just memorize complexities. For GATE, you should be able to **trace C code, determine output, analyze loops/recursion, understand pointer arithmetic, and derive 
